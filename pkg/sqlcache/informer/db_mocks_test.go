...
// Source: github.com/rancher/steve/pkg/sqlcache/db (interfaces: Rows,Client,TxClient)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package informer -destination ./db_mocks_test.go github.com/rancher/steve/pkg/sqlcache/db Rows,Client,TxClient
//
...
func (m *MockClient) Prepare(stmt string) db.VirtualStmt {
	m.ctrl.T.Helper()
...
func (m *MockClient) Upsert(tx db.TxClient, stmt db.VirtualStmt, key string, obj db.SerializedObject) error {
	m.ctrl.T.Helper()
...
func (m *MockTxClient) ExecStmt(query db.VirtualStmt, args ...any) (sql.Result, error) {
	m.ctrl.T.Helper()
	varargs := []any{query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockTxClient) Query(query string, args ...any) (db.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockTxClient) QueryStmt(query db.VirtualStmt, args ...any) (db.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{query}
	for _, a := range args {
		varargs = append(varargs, a)
